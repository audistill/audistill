      ...
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          <div className="hidden md:flex items-center gap-6 text-[13px] text-secondary">
            ...
            <a href={sectionHref("#source")} className="hover:text-text transition-colors duration-200">Source</a>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-1.5 text-secondary hover:text-text text-[13px] transition-colors duration-200"
            ...
            >
              ...
              <span className="font-[family-name:var(--font-mono)] text-[11px]">Source</span>
            </a>
            <a
