...
export function SettingsView(): React.JSX.Element {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-12 py-8">
      ...
      <ModelPicker
        label="Default Model"
        subtitle="Used for all Recipes unless overridden per Recipe"
        value={defaultModel}
      ...
      <div className="mb-8">
        <label className="block font-heading text-sm font-medium text-[var(--text)] mb-0.5">Pipeline Recipe</label>
        <p className="text-xs text-[var(--secondary)] mb-2">
          This Recipe auto-runs when you import new audio.
        </p>
        <select
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          <div>
            <label className="block font-heading text-sm font-medium text-[var(--text)]">Recipes</label>
            <p className="text-xs text-[var(--secondary)] mt-0.5">
              Reusable prompts that generate Tabs from Transcripts.
            </p>
          </div>
          <button
