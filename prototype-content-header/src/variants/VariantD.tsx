...
/**
 * Variant D: Three-line block
 * Line 1: [SourceIcon badge] Episode Title
 * Line 2: Secondary label · duration
 * Line 3: ● Brief  Detailed  Full  [+]       📄 Transcript ∧
 * Clear hierarchy: title dominates, metadata is quiet, tabs are navigation.
 */
export function VariantD({ episode }: { episode: Episode }) {
  ...
  return (
    <div className="border-b border-[var(--border)] shrink-0 px-4 pt-3 pb-0">
      ...
      <div className="flex items-center gap-2 mt-1 pl-[34px]">
        ...
        {!secondaryLabel && !episode.duration_sec && (
          <span className="text-[11px] text-[var(--secondary)] opacity-40">Local file</span>
        )}
      </div>
